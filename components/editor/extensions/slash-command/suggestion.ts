...
import {
	...
	TableIcon,
	TextQuoteIcon,
	BotIcon, // Add new icon for AI Completion
} from "lucide-react";
...
const withAiList: CommandSuggestionItem[] = [
	...
	{
		title: "AI Completion",
		description: "Block with real-time AI completions.",
		keywords: ["ai", "completion"],
		icon: BotIcon,
		command: ({ editor, range }) => {
			editor.chain().focus().deleteRange(range).setAiCompletion().run();
		},
	},
	...list,
];
