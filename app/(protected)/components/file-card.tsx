  ...
  return (
    ...
    >
      <Checkbox
        ...
        className="-translate-y-1/2 absolute top-1/2 left-2 opacity-0 group-hover:opacity-100 data-[state=checked]:opacity-100"
      />
          ...
          <>
            <div className="mb-1 flex items-center justify-between">
              ...
              <Link
                ...
                className="text-muted-foreground text-sm opacity-0 transition-opacity hover:text-primary group-hover:opacity-100"
              >
